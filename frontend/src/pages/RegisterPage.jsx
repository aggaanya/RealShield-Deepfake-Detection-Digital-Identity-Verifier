...
import { Shield, ArrowRight, EyeIcon, EyeOffIcon, CheckCircle, UserIcon, MailIcon, LockIcon } from 'lucide-react';
...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Register user using the auth store
        ...
        <div className="text-center mb-8">
          ...
          >
            <h1 className="text-3xl font-bold mb-2">
              Join <span className="gradient-text">RealShield</span>
            </h1>
            <p className="text-muted-foreground">
              Create an account to access deepfake detection tools
            </p>
          </motion.div>
        </div>
          ...
          <Card className="tech-card backdrop-blur-sm border-shield-100 dark:border-shield-800/50">
            ...
            <CardFooter className="flex flex-col space-y-4 pt-4">
              ...
              <p className="text-center text-xs text-muted-foreground mt-2">
                ...
                <Link to="/terms" className="text-shield-500 hover:underline">Terms of Service</Link>
                {' '}and{' '}
                <Link to="/privacy" className="text-shield-500 hover:underline">Privacy Policy</Link>.
              </p>
            </CardFooter>
          </Card>
        </motion.div>
