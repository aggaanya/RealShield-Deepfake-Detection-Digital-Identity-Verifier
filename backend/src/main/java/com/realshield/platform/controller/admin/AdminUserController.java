...
public class AdminUserController {
    ...
    public ResponseEntity<ApiResponse<Page<AdminUserResponseDTO>>> searchUser(
        ...
        return ResponseEntity.ok(
                ApiResponse.success(
                        ...
                        adminService.searchUsers(email, name, active, role != null ? Enum.valueOf(com.realshield.platform.model.Role.class, role) : null, page, size)
                )
        );
    }
    ...
    public ResponseEntity<ApiResponse<Page<AdminUserResponseDTO>>> getUsersPaginated(
        ...
        return ResponseEntity.ok(
                ApiResponse.success(
                        "Users fetched successfully",
                        adminService.getAllUsersPaginated(page, size, sortBy, sortDir)
                )
        );
    }
